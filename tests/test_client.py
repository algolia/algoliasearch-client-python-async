...
class ClientTest(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.index_name = [
            safe_index_name('àlgol?à1-python-async{0}'.format(randint(1, 1000))),
            safe_index_name('àlgol?à2-python-async{0}'.format(randint(1, 1000))),
        ]
